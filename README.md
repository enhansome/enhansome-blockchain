...
* [Bitcoin Improvement Proposals (BIPs)](https://github.com/bitcoin/bips/) ⭐ 10,926 | 🐛 54 | 🌐 Wikitext | 📅 2026-08-20
...
* Security
  * [**openzeppelin contracts**](https://github.com/OpenZeppelin/openzeppelin-contracts) ⭐ 27,232 | 🐛 373 | 🌐 Solidity | 📅 2026-08-25 / [doc](https://docs.openzeppelin.com/contracts/2.x/)
...
* [**Go**: *GoCoin - A full Bitcoin solution written in Go language (golang)*](https://github.com/piotrnar/gocoin) ⭐ 1,000 | 🐛 10 | 🌐 Go | 📅 2026-08-24
